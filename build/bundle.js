...
/***/ function(module, exports, __webpack_require__) {
	...
	var _paribasa = __webpack_require__(2);
	
	var _paribasa2 = _interopRequireDefault(_paribasa);
	
	var _kasustran = __webpack_require__(160);
	
	var _kasustran2 = _interopRequireDefault(_kasustran);
	
	var _ngendiko = __webpack_require__(161);
	
	var _ngendiko2 = _interopRequireDefault(_ngendiko);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_t3js2.default.Application.addService('paribasa', function (application) {
	  var Paribasa = _react2.default.createClass({
	    displayName: 'Paribasa',
	
	    updateParibasa: function updateParibasa(event) {
	      if (event.key === 'Enter') {
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { onKeyPress: this.updateParibasa })
	      );
	    }
	  });
	  return Paribasa;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_t3js2.default.Application.addService('kasustran', function (application) {
	
	  var Paribasa = application.getService('paribasa');
	
	  var Kasustran = _react2.default.createClass({
	    displayName: 'Kasustran',
	
	    render: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(Paribasa, null)
	      );
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	_t3js2.default.Application.addModule('Ngendiko', function (context) {
	  var _ngendiko = undefined,
	      Kasustran = undefined;
	
	  var Ngendiko = _react2.default.createClass({
	    displayName: 'Ngendiko',
	
	    getInitialState: function getInitialState() {
	      return { cecak: '' };
	    },
	    componentDidMount: function componentDidMount() {
	      _t3js2.default.Application.on('message', function (event) {
	        if (event.data.message === 'paribasaChange') {
	          console.log('React: ' + event.data.messageData.data);
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(Kasustran, null)
	      );
	    }
	  });
	
	  function render() {
	    _ngendiko = _reactDom2.default.render(_react2.default.createElement(Ngendiko, null), context.getElement());
